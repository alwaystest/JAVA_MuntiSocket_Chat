...
/**
 * socket class.
 * for handle socket. pass event to support.
 * connect, read, send, close
 *
 */
...
public class MultiSocket extends Thread {
	...
	public void run() {
		...
		while (true) {
			try {
				MultiDatagramPacket packet = (MultiDatagramPacket) in
						.readObject();
	...
	public void sendPacket(MultiDatagramPacket packet) {
		try {
